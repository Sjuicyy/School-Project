        ...
        <div class="owl-carousel hero-carousel">
          <div class="hero-carousel-item">
            ...
            <div class="img-caption">
              <div class="subhead">नमस्ते, सरस्वती माविको वेबसाईटमा</div>
              <h1 class="mb-4">यहाँहरुलाई स्वागत छ । </h1>
        ...
        <div class="row align-items-center">
          <div class="col-lg-6 py-3">
            ...
            <p align="justify">दक्षिण ललितपुरको विकट गाउँ चन्दनपुर नमनडाँडामा वि.सं. २०३० साल माघ २१ गते स्थापित यस श्री
              ...
              शिक्षिकाज्यूहरूप्रति हार्दिक सम्मान गदछौँ । विद्यालयलाई कक्षा १–३, १–५, १–७, १–८ र हाल १–१० सम्म सञ्चालन
              हुँदै गर्न÷गराउन सम्पूर्ण यस क्षेत्रका शिक्षाप्रेमी अभिभावकज्यूहरूको महत्वपूर्ण सहयोगको उच्च मूल्याङ्कन
              विद्यालयले गरेको
              छ । जसले गरेको योगदानले आज यो क्षेत्रका सम्पूर्णको ज्ञानको ज्योति फैलाउन सहयोग पुगेको छ । </p>
          </div>
          <div class="col-lg-6 py-3">
            <div class="about-img">
            ...
            while ($data = mysqli_fetch_array($result)) {
              ...
              <div class="team-wrap">
                <div class="team-profile">
                  <img src="../../AdminPanel/SMC/<?php echo $data['Image'] ?>" height="300px" alt="">
                </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6 py-3">
            <div class="subhead">फोटोहरू</div>
            <h2 class="title-section">हाम्रो फोटोहरू</h2>
          </div>
          <div class="col-md-6 py-3 text-md-right">
            <a href="photos.php" class="btn btn-outline-primary">अन्य फोटोहरू <span
      ...
      <div class="container">
        ...
        <?php
          ...
          <div class="card-testimonial">
            ...
            <div class="author">
              <div class="avatar">
                <img src="../../AdminPanel/Testim/<?php echo $data['Image'] ?>" alt="">
              </div>
              <div class="d-inline-block ml-2">
                <div class="author-name"><?php echo $data['Name'] ?></div>
                <div class="author-info"><?php echo $data['Post'] ?></div>
              </div>
            </div>
          </div>
          <?php
