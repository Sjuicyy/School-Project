    ...
    <div class="container">
        <div class="main-body">
            <div class="row gutters-sm">
                ...
                require_once "CONNECTION.php";
                $id = $_GET['id'];
                $sql = "SELECT * FROM Membership LEFT JOIN students ON Membership.S_id = students.Contact WHERE S_id= '$id ' ";
                ...
                <div class="col-md-8">
                    ...
                    <div class="d-flex justify-content-around">
                        <form action="ACCEPTMEMBER.php" method="post">
                            <input type="hidden" name="S_id" value="<?php echo $data['S_id'] ?>">
                            <button type="submit" class="btn btn-primary">Accept</button>
                        </form>
                        <form action="REJECTMEMBER.php" method="post">
                            <div class="d-flex">
                                <input type="hidden" name="S_id" value="<?php echo $data['S_id'] ?>">
