    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <p class="h5 text-end badge text-wrap text-break text-start text-dark w-25" style="width: 10rem;"
            id="exampleModalLabel">Date
            :
            <?php echo $data['Date'] ?>
            </>
        </div>
        <div class="modal-body mx-auto">
          <center>
            <img src="../AdminPanel/Notices/<?php echo $data['Photo'] ?>" width="90%" class="img-fluid" alt=""
              srcset="">
          </center>
        </div>
        <div class="modal-footer">
          ...
          <form action="DELETE-NOTICE.PHP" method="post">
