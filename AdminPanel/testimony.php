                    ...
                    <div class="card-body px-sm-4 px-0">
                        <div class="row justify-content-center">
                            <div class="col-md-10 mb-3">
                                <h3 class="font-weight-bold ml-md-0 mx-auto text-center text-sm-left">Add Testimony</h3>
                            </div>
                        </div>
                        <div class="row d-flex round">
                            <div class="col-lg-5 col-md-12 ">
                                <form action="ADD-TESTIMONY.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-lg-12">
                                                    <div class="form-group"><label for="Name">Post</label><input
                                                            type="text" name="post" class="form-control" id="Name"
                                                            placeholder="" required></div>
                                                </div>
                                            </div>
                                            <div class="row justify-content-center">
                                                <div class="col-lg-12">
                                                    <div class="form-group"><label for="Name">Message</label><input
                                                            type="text" name="message" class="form-control" id="Name"
                                                            placeholder="" required></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="notification-ui_dd-content mb-4 px-2">
                                                <div class="notification-list_content d-flex mt-3">
                                                    <div class="notification-list_img mx-auto">
                                                        <img src="Testim/<?php echo $data['Image'] ?>" width="100" alt="user">
                                                    </div>
                                                    <div class="notification-list_detail mx-auto">
                                                        ...
                                                        <div class="text-muted d-flex font-weight-bold">
                                                            Message:<p class="text-dark">
                                                                <?php echo $data['Message'] ?>
                                                            </p>
                                                        </div>
                                                    </div>
                                                    <div class="mx-auto">
                                                        <form action="DELETE-TESTIMONY.php" method="post">
