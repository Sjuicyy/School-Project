                    ...
                    <div class="card-body px-sm-4 px-0">
                        <div class="row justify-content-center">
                            <div class="col-md-10 mb-3">
                                <h3 class="font-weight-bold ml-md-0 mx-auto text-center text-sm-left">Add PTA Members</h3>
                            </div>
                        </div>
                        <div class="row d-flex round">
                            <div class="col-lg-5 col-md-12 ">
                                <form action="ADD-PMC.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="notification-ui_dd-content mb-4 px-2">
                                                <div class="notification-list_content d-flex mt-3">
                                                    <div class="notification-list_img mx-auto">
                                                        <img src="PMC/<?php echo $data['Image'] ?>" width="100" alt="user">
                                                    </div>
                                                    ...
                                                    <div class="mx-auto">
                                                        <form action="DELETE-PMC.php" method="post">
